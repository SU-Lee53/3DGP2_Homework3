...
namespace Vector3
{
	...
	inline XMFLOAT3 Add(const const XMFLOAT3& xmf3Vector1, const const XMFLOAT3& xmf3Vector2)
	{
		XMFLOAT3 xmf3Result;
	...
	inline XMFLOAT3 TransformCoord(const XMFLOAT3& xmf3Vector, XMMATRIX& xmmtxTransform)
	{
		XMFLOAT3 xmf3Result;
